function Computador(marca, procesador, ram, disco, precio, modelo){
    ...
    this.informacionComputador = function(){
        console.log(`
            \nEl computador ${marca} cuenta con un procesador 
            ${procesador}, además incluye ${ram}gb de memoria ram, 
            un disco ${disco}gb y el precio es de ${precio}\n`);
    }
}
